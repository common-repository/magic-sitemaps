			...
			<body>
				<div id="content">
					...
					<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
						...
						<p class="expl"><a href="'.$this->home_page.'/sitemap_index.xml">&#8593; Sitemap Index</a></p>
						<table id="sitemap" cellpadding="3">
							<thead>
								<tr>
									<th width="75%">URL</th>
				...
				<script type="text/javascript" src="'.plugin_dir_url( __FILE__ ).'jquery.tablesorter.min.js"></script>
